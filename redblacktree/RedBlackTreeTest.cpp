...
class RedBlackTreeTest:public ::testing::Test
{
    protected:
        void SetUp() override{
            ...
            {
                BinNode<int> * node = RedBlackTree<int>::make_node(vec[i]);
            ...
            {
                BinNode<int>* node = RedBlackTree<int>::make_node(vec_delete_case3[i]);
        ...
        RedBlackTree<int> _rb;
        RedBlackTree<int> _rb_delete_case3;
        RedBlackTree<int> _rb_delete_fixup;
};
...
{
    _rb.insert(RedBlackTree<int>::make_node(10));
    _rb.bfs();
    EXPECT_EQ(0,0);
}
...
{
    _rb.insert(RedBlackTree<int>::make_node(10));
    _rb.insert(RedBlackTree<int>::make_node(8));
